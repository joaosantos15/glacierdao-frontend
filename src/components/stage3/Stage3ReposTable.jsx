...
export const Stage3ReposTable = ({ repos, setRepos, activeUser, totalVotes }) => {
      ...
      {isExpanded ? (
        <tr key={repo.url + 'expanded'} className="bg-gray-50 px-6 py-8">
          <td colSpan="3" className="px-5 py-8">
            ...
            <p className="mt-16 mb-8 text-center text-lg">Have you verified that this deal is legitimate and the data corresponds to the repo?</p>
            <div className="grid grid-cols-2 justify-center mb-8">
              <button
                type="button"
                className="m-auto inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              ...
              <button
                type="button"
                className="m-auto inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                onClick={() => handleVote({url: repo.url, voteNo: true})}
              >
                Vote NO ❌
              </button>
            </div>
